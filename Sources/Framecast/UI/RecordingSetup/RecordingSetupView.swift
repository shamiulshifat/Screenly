...
struct RecordingSetupView: View {
    ...
    @AppStorage("framecast.onboarding.dismissed") private var onboardingChecklistDismissed = false
    ...
    private var permissionHelpSection: some View {
        setupCard(title: "Permissions", subtitle: "Jump directly to macOS privacy settings.", icon: "hand.raised") {
            Text("Framecast needs Screen Recording and Microphone permissions. Camera permission is optional.")
                .font(.caption)
                .foregroundStyle(.secondary)
