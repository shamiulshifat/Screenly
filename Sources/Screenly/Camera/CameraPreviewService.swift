...
final class CameraPreviewService: NSObject, ObservableObject {
    ...
    private let outputQueue = DispatchQueue(label: "com.screenly.camera.preview.output", qos: .userInitiated)
    private let configQueue = DispatchQueue(label: "com.screenly.camera.preview.config", qos: .userInitiated)
